...
def move_to_pose(pickPose, standalone, sim=True):
    if standalone:
        rclpy.init()
...
if __name__ == "__main__":
    move_to_pose(-0.4, standalone=True)  # Call move_to_pose with pickPose = -0.4 to -0.6 is the -x value of the pickPose